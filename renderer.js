...
var spreadsheetID = document
	...
	.addEventListener("change", function(e) {
		...
		document
			.getElementById("talkPicker")
			.addEventListener("change", function(e) {
				console.log(e);
				document.getElementById("speakerName").value =
					e.target.selectedOptions[0].talkTitle;
				document.getElementById("speakerTitle").value =
					e.target.selectedOptions[0].speakerName;
				...
				document.getElementById("trackTime").value = minTommss(
					e.target.selectedOptions[0].talkTime
				);
			});
	});
